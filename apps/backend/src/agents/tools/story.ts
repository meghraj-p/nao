...
export default createTool<story.Input, story.Output>({
	description: [
		...
		'Charts are embedded via <chart query_id="..." chart_type="bar|stacked_bar|line|area|pie|scatter" x_axis_key="..." series=\'[{"data_key":"col","label":"Label"},...]\' title="..." />.',
		...
		'Story content must be clean markdown only. Never include internal reasoning, tool-call syntax, JSON fragments, or non-content text in the story code.',
	].join(' '),
